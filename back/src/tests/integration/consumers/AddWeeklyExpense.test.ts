...
describe("Integration | Consumers | Routes | POST /months/{monthId}/weeks/{weekId}/expenses/", function () {
    ...
    describe("When user is authenticated", function () {
        ...
        it("should have persisted new expense and return a month DTO", async function () {
            ...
            const updatedWeek = await WeeklyBudgetDao.findOne({where: {id: weekId}});
            if (!updatedWeek) {
        ...
        it("should return 404 error if a model is not found", async function () {
            ...
            console.info(`/months/${monthId}/weeks/${notExistingWeekId}/expenses/`);
    ...
    describe("When user is not authenticated", function () {
        ...
        it("should return a 401 error", async function () {
            await request(server).post('/months/85467999-2751-4f04-8d96-7d7727fbff02/weeks/982b2aad-825b-4e8a-986d-8381554637da/expenses/').send({
                label: 'JOW',
                amount: 10,
            }).expect(401);
        });
