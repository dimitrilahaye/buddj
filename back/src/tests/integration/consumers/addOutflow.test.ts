...
describe("Integration | Consumers | Routes | PUT /months/{monthId}/outflows", function () {
    ...
    describe("When user is authenticated", function () {
        ...
        it("should return a 200 on happy path", async function () {
            ...
            depsStub.addOutflowUsecase.execute = sinon.stub().withArgs(command).resolves(updatedMonth);
            ...
            expect((depsStub.addOutflowUsecase.execute as SinonStub).args).to.deep.equal([[command]]);
        ...
        it("should return 404 error if a model is not found", async function () {
            ...
            deps.addOutflowUsecase.execute = sinon.stub().withArgs(command).throwsException(new MonthNotFoundError());
