...
describe("Unit | Core | Models | Month | Month", function () {
  ...
  describe("#addExpenseToWeeklyBudget", function () {
    it("should call its account to add the new expense", function () {
      ...
      accountStub.addExpenseToWeeklyBudget = sinon
        .stub()
        .withArgs(targetedWeeklyBudget, newExpense);
      const props = {
        id: "uuid",
        date: new Date(),
        account: accountStub,
      ...
      // then
      expect(accountStub.addExpenseToWeeklyBudget).to.have.been.calledOnceWith(
        targetedWeeklyBudget,
        newExpense
      );
    });
  });
  ...
  describe("#deleteExpenseFromWeeklyBudget", function () {
    it("should call its account to add delete the expense", function () {
      ...
      accountStub.deleteExpenseFromWeeklyBudget = sinon
        .stub()
        .withArgs(targetedWeeklyBudgetId, expenseIdToDelete);
      const props = {
        id: "uuid",
        date: new Date(),
        account: accountStub,
      ...
      // when
      month.deleteExpenseFromWeeklyBudget(
      ...
      // then
      expect(
        accountStub.deleteExpenseFromWeeklyBudget
      ).to.have.been.calledOnceWith(targetedWeeklyBudgetId, expenseIdToDelete);
    });
  });
  ...
  describe("#checkExpense", function () {
    it("should call its account to check the expense", function () {
      ...
      accountStub.checkExpense = sinon
        .stub()
        .withArgs(targetedWeeklyBudgetId, targetedWeeklyExpenseId);
      const props = {
        id: "uuid",
        date: new Date(),
        account: accountStub,
      ...
      // then
      expect(accountStub.checkExpense).to.have.been.calledOnceWith(
        targetedWeeklyBudgetId,
        targetedWeeklyExpenseId
      );
    });
  });
  ...
  describe("#uncheckExpense", function () {
    it("should call its account to check the expense", function () {
      ...
      accountStub.uncheckExpense = sinon
        .stub()
        .withArgs(targetedWeeklyBudgetId, targetedWeeklyExpenseId);
      const props = {
        id: "uuid",
      ...
      // then
      expect(accountStub.uncheckExpense).to.have.been.calledOnceWith(
        targetedWeeklyBudgetId,
        targetedWeeklyExpenseId
      );
    });
  ...
  describe("#updateAccountCurrentBalance", function () {
    it("should call its account update its current balance", function () {
      ...
      // then
      expect(accountStub.updateCurrentBalance).to.have.been.calledOnceWith(
        givenNewCurrentBalance
      );
    });
  });
  ...
  describe("#checkOutflow", function () {
    it("should call its account to check the outflow", function () {
      ...
      // then
      expect(accountStub.checkOutflow).to.have.been.calledOnceWith(
        targetedOutflowId
      );
    });
  });
  ...
  describe("#uncheckExpense", function () {
    it("should call its account to check the expense", function () {
      ...
      // then
      expect(accountStub.uncheckOutflow).to.have.been.calledOnceWith(
        targetedOutflowId
      );
    });
  });
  ...
  describe("#updateExpenseAmountFromWeeklyBudget", function () {
    it("should call the account to update the expense amount", () => {
      ...
      // then
      expect(
        accountStub.updateExpenseAmountFromWeeklyBudget
  ...
  describe("#updateExpenseLabelFromWeeklyBudget", function () {
    it("should call the account to update the expense label", () => {
      ...
      // then
      expect(
        accountStub.updateExpenseLabelFromWeeklyBudget
      ).to.have.been.calledOnceWith(
        targetedWeeklyBudgetId,
        targetedWeeklyExpenseId,
        "JODI"
  ...
  describe("#updateExpenseWeeklyBudget", function () {
    it("should call the account to change the weekly of the expense", () => {
      ...
      // then
      expect(accountStub.updateExpenseWeeklyBudget).to.have.been.calledOnceWith(
        oldWeeklyBudgetId,
        newWeeklyBudgetId,
        targetedWeeklyExpenseId
      );
