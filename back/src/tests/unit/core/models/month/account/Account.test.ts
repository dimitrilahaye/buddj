...
} from "../../../../../../core/errors/AccountErrors.js";
...
describe("Unit | Core | Models | Month | Account | Account", function () {
    describe("#constructor", function () {
        ...
        it("should throw an error if account does not contain 5 weekly budgets", function () {
            // given
            const props = {
                id: 'uuid',
                currentBalance: 2000,
            ...
            // when / then
            expect(() => new Account(props)).to.throw(AccountWeeklyBudgetsError);
        });
        it("should throw an error if account contains 0 outflow", function () {
            // given
            const props = {
                id: 'uuid',
                currentBalance: 2000,
            ...
            // when / then
            expect(() => new Account(props)).to.throw(AccountOutflowsError);
        });
    });
    describe('#addExpenseToWeeklyBudget', function () {
        it('should call the right weekly budget to add the new expense', function () {
            ...
            // then
            expect(weeklyBudgetStub.addExpense).to.have.been.calledOnceWith(newExpense);
        });
        it('should throw an error if weekly budget does not exist', function () {
            ...
            // when / then
            expect(() => account.addExpenseToWeeklyBudget('not-existing-budget-id', newExpense)).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    describe('#checkExpense', function () {
        it('should call the right weekly budget to check an expense', function () {
            ...
            // then
            expect(weeklyBudgetStub.checkExpense).to.have.been.calledOnceWith(targetedExpenseId);
        });
        it('should throw an error if weekly budget does not exist', function () {
            // given
            const props = {
            ...
            // when / then
            expect(() => account.checkExpense('not-existing-budget-id', 'weekly-expense-id')).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    describe('#uncheckExpense', function () {
        it('should call the right weekly budget to check an expense', function () {
            ...
            weeklyBudgetStub.uncheckExpense = sinon.stub().withArgs(targetedExpenseId);
            const props = {
                id: 'uuid',
                currentBalance: 2000,
                outflows: [
            ...
            // then
            expect(weeklyBudgetStub.uncheckExpense).to.have.been.calledOnceWith(targetedExpenseId);
        });
        it('should throw an error if weekly budget does not exist', function () {
            // given
            const props = {
            ...
            // when / then
            expect(() => account.uncheckExpense('not-existing-budget-id', 'weekly-expense-id')).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    ...
    describe('#checkOutflow', function () {
        ...
        it('should throw an error if outflow does not exist', function () {
            ...
            // when / then
            expect(() => account.checkOutflow('not-existing-outflow-id')).to.throw(AccountOutflowNotFoundError);
        });
    });
    describe('#uncheckOutflow', function () {
        ...
        it('should throw an error if outflow does not exist', function () {
            ...
            // when / then
            expect(() => account.uncheckOutflow('not-existing-outflow-id')).to.throw(AccountOutflowNotFoundError);
        });
    });
    describe('#deleteExpenseFromWeeklyBudget', function () {
        it('should call the right weekly budget', function () {
            ...
            // when
            account.deleteExpenseFromWeeklyBudget(targetedWeeklyBudgetId, expenseIdToDelete);

            // then
            expect(weeklyBudgetStub.deleteExpenseById).to.have.been.calledOnceWith(expenseIdToDelete);
        });
        it('should throw an error if weekly budget does not exist', function () {
            // given
            const expenseIdToDelete = 'expense-to-delete';
            ...
            expect(() => account.deleteExpenseFromWeeklyBudget('not-existing-budget-id', expenseIdToDelete)).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    describe('#updateExpenseAmountFromWeeklyBudget', function () {
        it('should call the right weekly budget', function () {
            ...
            // when
            account.updateExpenseAmountFromWeeklyBudget(targetedWeeklyBudgetId, expenseIdToUpdate, 30);

            // then
            expect(weeklyBudgetStub.updateExpenseAmount).to.have.been.calledOnceWith(expenseIdToUpdate, 30);
        });
        it('should throw an error if weekly budget does not exist', function () {
// given
            const expenseIdToUpdate = 'expense-to-delete';
            ...
            // when / then
            expect(() => account.updateExpenseAmountFromWeeklyBudget('not-existing-weekly-id', expenseIdToUpdate, 30)).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    describe('#updateExpenseLabelFromWeeklyBudget', function () {
        it('should call the right weekly budget', function () {
            ...
            // when
            account.updateExpenseLabelFromWeeklyBudget(targetedWeeklyBudgetId, expenseIdToUpdate, 'JODI');

            // then
            expect(weeklyBudgetStub.updateExpenseLabel).to.have.been.calledOnceWith(expenseIdToUpdate, 'JODI');
        });
        it('should throw an error if weekly budget does not exist', function () {
            // given
            const expenseIdToUpdate = 'expense-to-delete';
            ...
            // when / then
            expect(() => account.updateExpenseLabelFromWeeklyBudget('not-existing-weekly-id', expenseIdToUpdate, 'JODI')).to.throw(WeeklyBudgetNotFoundError);
        });
    });
    describe('#updateExpenseWeeklyBudget', function () {
        it('should change the weekly budget of the expense', function () {
            ...
            // when
            account.updateExpenseWeeklyBudget(originalWeeklyId, newWeeklyId, expenseIdToMove);
        ...
        it('should not change when original id and new id are the same', function () {
            ...
            // when
            account.updateExpenseWeeklyBudget(originalWeeklyId, originalWeeklyId, expenseIdToMove);
