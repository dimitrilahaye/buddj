...
describe("Unit | Core | Models | Month | Account | WeeklyBudget", function () {
    describe("#constructor", function () {
        ...
        it("should throw an error if current balance is negative", function () {
            ...
            // when / then
            expect(() => new WeeklyBudget(props)).to.throw(WeeklyBudgetInitialBalanceError);
        });
    ...
    describe("#checkExpense", function () {
        ...
        it("should throw an error if expense does not exist", function () {
            ...
            // when / then
            expect(() => budget.checkExpense('unknown-expense-id')).to.throw(WeeklyExpenseNotFoundError);
        });
    });
    describe("#uncheckExpense", function () {
        ...
        it("should throw an error if expense does not exist", function () {
            ...
            // when / then
            expect(() => budget.uncheckExpense('unknown-expense-id')).to.throw(WeeklyExpenseNotFoundError);
        });
    });
    ...
    describe("#updateExpenseAmount", function () {
        ...
        it("should throw an error if expense does not exist", function () {
            ...
            // when / then
            expect(() => budget.updateExpenseAmount('not-existing-id', 20)).to.throw(WeeklyExpenseNotFoundError);
        });
    });
    describe("#updateExpenseLabel", function () {
        it('should call the expense to update its label', function () {
            ...
            // then
            expect(existingExpenseStub.updateLabel).to.have.been.calledOnceWith('JODI');
        });
        it("should throw an error if expense does not exist", function () {
            // given
            const props = {
            ...
            // when / then
            expect(() => budget.updateExpenseLabel('not-existing-id', 'JODI')).to.throw(WeeklyExpenseNotFoundError);
        });
    });
    describe('#findExpenseById', function () {
        ...
        it('should throw an error if expense is not found', function () {
            ...
            // when / then
            expect(() => budget.findExpenseById('not-existing-id')).to.throw(WeeklyExpenseNotFoundError);
        });
    });
