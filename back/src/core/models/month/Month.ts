...
export default class Month {
    ...
    constructor(props: { id: string, date: Date, account: Account, isArchived?: boolean }) {
        this.id = props.id;
    ...
    updateExpenseWeeklyBudget(originalWeeklyId: string, newWeeklyId: string, expenseId: string) {
        this.account.updateExpenseWeeklyBudget(originalWeeklyId, newWeeklyId, expenseId);
    }
    ...
    updateExpenseAmountFromWeeklyBudget(weeklyId: string, expenseId: string, amount: number) {
        this.account.updateExpenseAmountFromWeeklyBudget(weeklyId, expenseId, amount);
    }
