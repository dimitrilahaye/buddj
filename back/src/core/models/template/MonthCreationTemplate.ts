...
import {MonthCreationOutflowsError, MonthCreationTemplateWeeklyBudgetError} from "../../errors/MonthCreationTemplateErrors.js";
...
export default class MonthCreationTemplate {
    ...
    constructor(props: {weeklyBudgets: WeeklyBudgetTemplate[], outflows: OutflowTemplate[]}) {
        this.month = new Date();
