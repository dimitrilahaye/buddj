...
export default class UpdateExpense {
    ...
    async execute(command: UpdateExpenseCommand) {
        ...
        month.updateExpenseAmountFromWeeklyBudget(command.originalWeeklyId, command.expenseId, command.amount);
        month.updateExpenseLabelFromWeeklyBudget(command.originalWeeklyId, command.expenseId, command.label);
        month.updateExpenseWeeklyBudget(command.originalWeeklyId, command.newWeeklyId, command.expenseId);
